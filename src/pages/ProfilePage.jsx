...
const ProfilePage = () => {
  ...
  // Masked password for display (same length as real password)
  const maskedPassword = "*".repeat(decryptPassword(user.password).length);
            ...
            <div className="space-y-3 text-white">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="font-medium">{maskedPassword}</p>
                )}
              </div>
